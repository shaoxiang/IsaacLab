...
while [[ $# -gt 0 ]]; do
    ...
    case "$1" in
        -i|--install)
            ...
            ${python_exe} -m pip install -i https://pypi.tuna.tsinghua.edu.cn/simple -e ${ISAACLAB_PATH}/source/isaaclab_rl["${framework_name}"]
            ${python_exe} -m pip install -i https://pypi.tuna.tsinghua.edu.cn/simple -e ${ISAACLAB_PATH}/source/isaaclab_mimic["${framework_name}"]
