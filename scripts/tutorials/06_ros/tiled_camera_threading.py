...
.. code-block:: bash
    ...
    # Usage
    ./isaaclab.sh -p scripts/tutorials/06_ros/tiled_camera_threading.py --enable_cameras

    # Usage in headless mode
    ./isaaclab.sh -p scripts/tutorials/06_ros/tiled_camera_threading.py --headless --enable_cameras
...
class RobotBaseNode():
    def __init__(self, num_envs):
        self.node = rclpy.create_node("tiled_camera_driver_node")
        qos_profile = QoSProfile(depth=10)
        self.image_pub = []
        for i in range(num_envs):
            self.image_pub.append(self.node.create_publisher(Image, f'robot{i}/tiled_camera', qos_profile))
