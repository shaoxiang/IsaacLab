...
.. code-block:: bash
    ...
    # Usage
    ./isaaclab.sh -p scripts/tutorials/04_sensors/add_more_sensors_on_robot.py --enable_cameras
...
from isaaclab.sensors import CameraCfg, ContactSensorCfg, RayCasterCfg, patterns, RTXRayCasterCfg, TiledCameraCfg
...
class SensorsSceneCfg(InteractiveSceneCfg):
    ...
    tiled_camera = TiledCameraCfg(
        prim_path="{ENV_REGEX_NS}/Robot/base/back_cam",
        update_period=0.1,
        height=480,
        width=640,
        data_types=["rgb", "distance_to_image_plane"],
