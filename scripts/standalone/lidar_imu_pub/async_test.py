...
To use the internal libraries included with the extension please set:
RMW_IMPLEMENTATION=rmw_fastrtps_cpp
PATH=%PATH%;d:/omniverse/pkg/isaaclab/_isaac_sim/exts/isaacsim.ros2.bridge/humble/lib
...
async def main():
    ...
    env_cfg.episode_length_s = 1000000.0
