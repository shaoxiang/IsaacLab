...
.. code-block:: bash
    ...
    # Usage
    ./isaaclab.sh -p source/standalone/demos/multi_asset_more.py --num_envs 128
...
class MultiObjectSceneCfg(InteractiveSceneCfg):
    ...
    # Deformable Object
    tennis_ball = DeformableObjectCfg(
...
def run_simulator(sim: SimulationContext, scene: InteractiveScene):
    ...
    deformable_object: DeformableObject = scene["tennis_ball"]
    ...
    while simulation_app.is_running():
        ...
        if count % 250 == 0:
            ...
            rigid_object_collection.write_object_pose_to_sim(object_state[..., :7])
            rigid_object_collection.write_object_velocity_to_sim(object_state[..., 7:])
            # deformable object 
