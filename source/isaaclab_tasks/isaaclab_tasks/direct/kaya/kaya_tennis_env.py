...
from isaaclab.assets import Articulation, ArticulationCfg, DeformableObject, DeformableObjectCfg, RigidObjectCfg, AssetBaseCfg
...
# Pre-defined configs
##
from isaaclab_assets import KAYA_TENNIS_CFG, TENNIS_BALL_CFG   # isort: skip
