...
class QuadcopterEnvWindow(BaseEnvWindow):
    ...
    def __init__(self, env: QuadcopterVisionDepthEnv, window_name: str = "IsaacLab"):
...
@configclass
class QuadcopterVisionDepthEnvCfg(DirectRLEnvCfg):
    ...
    scene: InteractiveSceneCfg = InteractiveSceneCfg(num_envs=4, env_spacing=2.5, replicate_physics=True) # 65536
    # scene: InteractiveSceneCfg = InteractiveSceneCfg(num_envs=4096, env_spacing=2.5, replicate_physics=True) 
    # 8192
    # robot
...
class QuadcopterVisionDepthEnv(DirectRLEnv):
    cfg: QuadcopterVisionDepthEnvCfg

    def __init__(
        self, cfg: QuadcopterVisionDepthEnvCfg, render_mode: str | None = None, **kwargs
    ):
    ...
    def _get_observations(self) -> dict:
        ...
        depth_encode = self.rgb_to_depth()
        ...
        observations = {"policy": {"img": depth_encode, "vec": obs}}
