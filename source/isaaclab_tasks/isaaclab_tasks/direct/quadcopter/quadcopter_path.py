...
class QuadcopterEnvCfg(DirectRLEnvCfg):
    ...
    scene: InteractiveSceneCfg = InteractiveSceneCfg(num_envs=1, env_spacing=5.0, replicate_physics=True) # 65536 32768 16384 
    # scene: InteractiveSceneCfg = InteractiveSceneCfg(num_envs=4096, env_spacing=2.5, replicate_physics=True) 
    # 8192
    # robot
...
class QuadcopterEnv(DirectRLEnv):
    ...
    def _pre_physics_step(self, actions: torch.Tensor):
        self._actions = actions.clone().clamp(-0.2, 0.2)
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        print("root_ang_vel_b_clone:", root_ang_vel_b_clone)
    ...
    #     died = torch.logical_or(self._robot.data.root_pos_w[:, 2] < 0.1, self._robot.data.root_pos_w[:, 2] > 20.0)
    ...
    def tunnel_flight_path(self):
        path_point_list = np.array([(16.857454, 4.733797, 3), (23.785446, 0.7394848, 3), (37.238182, -5.8582616, 3), (50.593536, -10.577381, 3), (61.530663, -8.310559, 3), (66.24306, -6.116083, 3), (89.07483, 16.195843, 3), (86.178894, 15.035391, 3.0), (71.75105, 0.41696435, 3.0), (55.901173, -11.562683, 3.0), (40.07982, -6.569447, 3.0), (7.67947, 7.4372797, 3.0)])
        path_quaternion_list = []
