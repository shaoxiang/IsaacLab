...
class RangeSensorData:
    """Data container for the range sensor."""
    ...
    - ``"num_cols_ticked"``: The number of vertical scans the sensor completed in the last simulation step, 0 if error occurred. Generally only useful for range sensors with a non-zero rotation speed.
